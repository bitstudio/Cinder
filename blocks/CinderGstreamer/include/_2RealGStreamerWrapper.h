...
namespace _2RealGStreamerWrapper
{
	...
	*/
	#ifdef __unix__    //NOTE: I don't really like this here but it's necessary. Go here if you have probs with constants defs (ottona)
        #undef BIG_ENDIAN
        #undef LITTLE_ENDIAN
    #endif
	enum Endianness
	...
	*/
	...
	public:
		...
		*/
		void					close( bool joinThread = true );
	...
	private:
		...
		*/
		...
		/*
			...
			@listener: Reference to an instance of an class, needed for additional calls ("this" in this case)
		*/
		static GstFlowReturn	onNewSampleFromVideoSource(GstAppSink* appsink, void* listener);
		...
		/*
			...
			@listener: Reference to an instance of an class, needed for additional calls ("this" in this case)
		*/
		static GstFlowReturn	onNewSampleFromAudioSource(GstAppSink* appsink, void* listener);
		...
		*/
		...
		/*
			...
			@videoSinkBuffer: The buffer that was gathered from the video sink
		*/
		void					newVideoSinkSampleCallback(GstSample* videoSinkBuffer);
		...
		*/
		void					newAudioSinkSampleCallback(GstSample* audioSinkBuffer);
